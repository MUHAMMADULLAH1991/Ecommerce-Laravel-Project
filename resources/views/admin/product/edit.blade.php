                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <!--end::Header-->
                            <!--begin::Form-->
                            <form method="POST" action="{{ url('/manage/product-update/' . $product->id) }}"
                                ...
                                <div class="card-body">
                                                ...
                                                @if ($product->color->isNotEmpty())
                                                    @foreach ($product->color as $singleColor)
                                                        <input type="text" class="form-control mb-2" name="color_name[]"
                                                            value="{{ $singleColor->color_name }}" placeholder="Color Name"
                                                            id="color_name" />
                                                    @endforeach
                                                @else
                                                    <input type="text" class="form-control mb-2" name="color_name[]"
                                                ...
                                                @if ($product->size->isNotEmpty())
                                                    @foreach ($product->size as $singleSize)
                                                        <input type="text" class="form-control mb-2" name="size_name[]"
                                                            value="{{ $singleSize->size_name }}" placeholder="Size Name"
                                                            id="size_name" />
                                                    @endforeach
                                                @else
                                                    <input type="text" class="form-control mb-2" name="size_name[]"
                                        ...
                                        <div class="col-md-6 col-sm-12 col-12">
                                            <div class="mb-3">
                                                ...
                                                <select name="product_type" id="product_type" class="form-control">
                                                    <option value="hot"
                                                        @if ($product->product_type == 'hot') selected @endif>Hot Product
                                                    </option>
                                                    <option value="new"
                                                        @if ($product->product_type == 'new') selected @endif>New Product
                                                    </option>
                                                    <option value="regular"
                                                        @if ($product->product_type == 'regular') selected @endif>Regular Product
                                                    </option>
                                                    <option value="discount"
                                                        @if ($product->product_type == 'discount') selected @endif>Discount Product
                                                    </option>
                                                </select>
                                                @error('product_type')
                                                    <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12">
                                        ...
                                        @foreach ($product->galleryImage as $singleImage)
                                            <img src="{{ $singleImage->image }}" height="100" width="100"
                                                class="mb-3">
                                        @endforeach
                                        @error('gallery_image')
                                            <span class="text-danger">{{ $message }}</span>
